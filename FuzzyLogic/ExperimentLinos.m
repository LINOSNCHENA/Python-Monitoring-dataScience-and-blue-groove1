...
%==========================================================================
Ca =[(1-a1);            a1 ;        b1]%  (1-a1)*(1-a1)] ; % Wrong
Cb =[b1;       b1*(1-a1);       b1*((1-a1)*(1-a1)+a1)] ;    % Correct
for j=1:(2)
...
%==========================================================================
for i=1:(n2-3)
CaS=[CaS;(1-a1)*Ca(3)+(a1)*Ca(2) ...
    (1-a1)*Ca(3)+(a1)*Ca(2) (1-a1)*Ca(3)+(a1)*Ca(2) ];
Ca=[Ca(2:3,:);(1-a1)*Ca(3)+(a1)*Ca(2)...
    (1-a1)*Ca(3)+(a1)*Ca(2) (1-a1)*Ca(3)+(a1)*Ca(2) ];

CbS=[CbS;(1-a1)*Cb(3,1)+(a1)*Cb(2,1) ...
    (1-a1)*Cb(3,2)+(a1)*Cb(2,2) (1-a1)*Cb(3,3)+(a1)*Cb(2,3) ];
Cb=[Cb(2:3,:);(1-a1)*Cb(3,1)+(a1)*Cb(2,1)...
     (1-a1)*Cb(3,2)+(a1)*Cb(2,2) (1-a1)*Cb(3,3)+(a1)*Cb(2,3)]; 

end

%AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA =Q
Cx1=CaS
Cp2=Cb
Ca=[CaS(n2-1,1) 0 0;...
    CaS(n2-1,1) CaS(n2-1,1) 0; ...
    CaS(n2-0,1) CaS(n2-1,1)  CaS(n2-1,1) ] ;
HA=[CaS(n2-1,1) CaS(n2-0,1);...
    CaS(n2-0,1) CaS(n2+0,1);...
    CaS(n2+0,1) CaS(n2+0,1) ];
% Bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb=  H/P
Cb=[CbS(n2-2,1) 0 0;...
