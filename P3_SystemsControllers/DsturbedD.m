...
for k=1:200
z(k)=k;
west3=N*[v((k+n1-1):(k+n2-1))'];       % DisturbanceInjecktor
east3=NS*[100 ; 100];                  % DisturbanceMeasurering_CONSTANT
...
errSize=sqrt(XA)
inputSize=sqrt(XB)
disp('*************************ConstantCompersation*********')
figure;                                 plot(z,u,z,y,z,ref(1:200));
legend('inputSize','actualResult','desiredResult', 'location', 'best')
title('Constant-Compersation_4');
KoefficientsOfDiofant_x_G_NS =[x G NS]; DsturbedZ
